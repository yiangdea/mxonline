...
class UserProfile(AbstractUser):
    ...
    birtyday = models.DateField(verbose_name=u"生日", null=True, blank=True)
    gender = models.CharField(max_length=10, choices=(("male", u"男"), ("female", u"女")), default="female")
    address = models.CharField(max_length=100, default="")
    mobile = models.CharField(max_length=11, null=True, blank=True)
    avatar_image = models.ImageField(upload_to="image/%Y/%m", default=u"image/default.png", max_length=100)
...
class EmailVerifyRecord(models.Model):
    ...
    send_time = models.TimeField(default=datetime.now, verbose_name=u"发送时间")
